        ...
        <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
          {skills.map((skill) => (
            <div key={skill} className="p-2 sm:w-1/2 w-full ">
              <div className="bg-gray-800 rounded-full flex p-4 h-full items-center hover:bg-gray-500 cursor-pointer hover:rotate-12 transition duration-500 ease-in-out">
